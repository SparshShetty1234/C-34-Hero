...
function setup() {
  ...
  box2 = new Box(885, 100, 70, 70);
  box3 = new Box(885, 100, 70, 70);
  box12 = new Box(885, 100, 70, 70);
  box13 = new Box(885, 100, 70, 70);
  box14 = new Box(885, 100, 70, 70);
  box15 = new Box(885, 100, 70, 70);
  box16 = new Box(885, 100, 70, 70);
  box5=new Box(600,120,70,70)
  box6=new Box(600,130,70,70)
  ...
  box29=new Box(670,100,70,70)
  box30=new Box(670,100,70,70)
  box31=new Box(670,100,70,70)
